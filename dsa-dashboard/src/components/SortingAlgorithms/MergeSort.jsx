...
export default function MergeSort() {
  ...
  const merge = async (arr, left, mid, right) => {
    ...
    while (i < n1 && j < n2) {
      ...
      setComparison(`Comparing ${L[i]} and ${R[j]}`);
  ...
  const handleSort = async () => {
    ...
    setHighlightIndices([]);
    setAnimationStep(0);
    setComparison('Starting Merge Sort...');
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        {isDefinitionOpen && (
          <div className="mt-4 p-4 bg-white rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-pink-700 mb-2">What is Merge Sort?</h3>
            <p className="text-gray-700 mb-4">
              Merge Sort is a divide-and-conquer algorithm that recursively breaks down a problem into smaller subproblems until they become simple enough to solve directly.
            </p>
            ...
            <p className="text-gray-700">O(n) - Requires additional space for temporary arrays</p>
          </div>
        )}
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-pink-600">Merge Sort</h2>
          {error && (
